...
// NOTE: the 'agent-core' dir does not exist in this fork (actual dir is 'agent');
// existsSync below guards it so this list can stay aligned with the packaging
// scripts that consume the manifest emitted at the end of this file.
